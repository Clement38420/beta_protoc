 ...
 *        This function is called by the dispatcher when a SensorData message is successfully received and deserialized.
 * @param msg Pointer to the deserialized SensorData message struct.
 */
void on_sensor_data_received(SensorData *msg);
/**
 * @brief Weak callback function to be implemented by the user.
 *        This function is called by the dispatcher when a Value message is successfully received and deserialized.
 * @param msg Pointer to the deserialized Value message struct.
 */
void on_value_received(Value *msg);
